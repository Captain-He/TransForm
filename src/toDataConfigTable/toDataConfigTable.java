package toDataConfigTable;

import java.util.HashMap;
import java.util.Map;

public class toDataConfigTable {
...
//					int diandev = 0;
					...
					int dianliu = 0;
					int diancong = 0;
					for(int j = 0;j < data[dianli][3].length;j++){
...
//							}
					...
					int devjidi = 0; //
					int devjishu = 0;
					for(int j = 0;j < data2[2][1].length;j++){
						if (data2[2][1][j] == null) 
							break;
...
//					}
					...
					int pcid = 0;
					int chuanip = 0;
					for(int j = 0;j < data[tongguan][2].length;j++){
